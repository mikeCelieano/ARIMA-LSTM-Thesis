...
def render_hybrid_navbar(show_prediction_controls=False, currency="USD/IDR", model="ARIMA", mode="Tuning"):
    ...
    navbar_html = (
        ...
        f'<span class="gree-brand">&#128184; Gree</span>'
        f'{controls_html}'
        f'</div>'
        f'<span class="gree-theme-toggle">{theme_icon}</span>'
        f'</div>'
        f'<nav class="gree-nav-sidebar">'
        f'<a href="/" target="_parent" class="gree-nav-item"><span class="gree-nav-icon">&#127968;</span><span>Beranda</span></a>'
        f'<a href="/prediction" target="_parent" class="gree-nav-item"><span class="gree-nav-icon">&#128302;</span><span>Prediksi</span></a>'
        f'<a href="/eda" target="_parent" class="gree-nav-item"><span class="gree-nav-icon">&#128202;</span><span>EDA &amp; Insights</span></a>'
        f'<a href="/historical_analysis" target="_parent" class="gree-nav-item"><span class="gree-nav-icon">&#128200;</span><span>Analisis Historis</span></a>'
        f'<a href="/guide" target="_parent" class="gree-nav-item"><span class="gree-nav-icon">&#128214;</span><span>Panduan</span></a>'
        f'</nav>'
    )
