...
guide_page = st.Page("_pages/guide.py", title="Panduan", icon="💻")
historical_page = st.Page("_pages/historical_analysis.py", title="Analisis Historis", icon="📊")
prediction_page = st.Page("_pages/prediction.py", title="Prediksi", icon="📈")
