...
guide_page = st.Page("views/guide.py", title="Panduan", icon="💻")
historical_page = st.Page("views/historical_analysis.py", title="Analisis Historis", icon="📊")
prediction_page = st.Page("views/prediction.py", title="Prediksi", icon="📈")
eda_page = st.Page("views/eda.py", title="EDA & Insights", icon="📊")
# 3. Navigasi
pg = st.navigation({
